 ...
 * Verify PHP Version!
 *
 * Alpha Bank requires at least PHP 7.4 to run properly
 * @ignore
 */
 ...
 * The Main Classes
 *
 * Alpha Bank requires a list of "independent" light-weight classes which are stored in the `CLASS_DIR`
 * In order words, any of the class file can be copied to another project outside Alpha Bank and work just fine
 */
$class = [
